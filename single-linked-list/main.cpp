...
public:
    ...
    void PopFront() noexcept {
        if (head_.next_node != nullptr) { // Проверяем, есть ли элементы в списке
            Node* temp = head_.next_node; // Сохраняем указатель на первый узел
            head_.next_node = head_.next_node->next_node; // Перемещаем указатель на следующий узел
